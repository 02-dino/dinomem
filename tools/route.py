...
SCHEMA = {
    ...
    "discriminators": [
        ...
        {"id": 5, "test": "durable_user_fact_or_pref",      "surface": "root", "file": ["AGENTS.md"], "leaf": "tools/config_tool.py",
         "redirect": "USER.md is FORBIDDEN (auto-generated, overwritten). A durable user rule/pref the agent must obey -> AGENTS.md (a behavioral rule) or a memory/ _pin_. A per-person fact -> memory/peers/ rep. NEVER USER.md."},
