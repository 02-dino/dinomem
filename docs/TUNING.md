...
**Tested models (mine).** For the **non-reasoning** tier, I tested **Haiku 4.5** and **Gemini Flash 3.1** — both work very well. For the **reasoning** tier (neuron), I tested **Sonnet 4.6 and GPT 5.4** — both work very well.
