...
>
> **Want this?** [dinomem-neuron](https://github.com/02-dino/dinomem-neuron) (paid add-on) adds full RAG support for long documents — contracts, books, legal text — stored separately and searchable without polluting memory.

> **Want this?** [dinomem-neuron](https://github.com/02-dino/dinomem-neuron) (paid add-on) also takes `_note_` further — if your note implies a date or deadline, it automatically creates a Google Calendar event and deletes the note when the date passes.
